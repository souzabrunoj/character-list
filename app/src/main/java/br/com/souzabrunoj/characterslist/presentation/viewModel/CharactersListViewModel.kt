...
class CharactersListViewModel(private val repositoryPaging: CharactersPagingListRepository) :
    ...
    fun getCharacters() = repositoryPaging.getCharactersList(nameFilter, statusFilter)
        .liveData
