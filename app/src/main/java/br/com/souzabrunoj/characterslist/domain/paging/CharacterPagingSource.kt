...
class CharacterPagingSource(private val service: CharactersListService) : PagingSource<Int, CharacterResultResponse>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CharacterResultResponse> {
        return try {
    ...
    override fun getRefreshKey(state: PagingState<Int, CharacterResultResponse>): Int? {
